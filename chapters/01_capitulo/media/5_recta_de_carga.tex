\begin{tikzpicture}[scale=0.8,>=stealth]
  ...
  \draw[->,gray] (0,-.4) -- (0,4.5) node[above,font=\scriptsize]{\(I_C\) [\unit{\milli\ampere}]};
  ...
  \draw[gray!50!blue,->] (-2.3,4) node[above,text width=1.5cm,align=center,font=\scriptsize,draw]{Punto de saturación} to[out=-90,in=120] (-0.1,2.9);
